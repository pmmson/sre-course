...
1. Проверяем работу кластера ETCD - смена лидера
Проверяем текущее состояние кластера и узнаем кто лидер. Останавливаем службу ETCD на выбранной ноде. Провереям выбран ли новый лидер и если да, кто теперь. Возвращаем остановленную ноду etcd в кластер. Фиксируем результат, проверяем алертинг системы мониторинга и логи.
