...
приложение восстановило свою работу в 21:41б но из-за звгрузки HAProxy - сбоем Prometheus - данные до периода рестарта Prometheus получить не удалось - из внешнего Prometheus в Kubernetes, можно пронаблюдать за восстановлением работоспособности приложения
